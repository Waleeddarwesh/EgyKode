...
![Cloud DevOps Capstone — the full architecture: Jenkins CI on EC2, an EKS cluster running three microservices and MySQL, delivered by Argo CD and watched by Prometheus](/diagrams/clouddevops-architecture.png)
...
| [01 — Project Overview](/learn/platform/project-overview) · [02 — Architecture](/learn/platform/system-architecture) | Look at the architecture diagram in Chapter 02 and find each component in it. |
...
| [18 — ECR](/learn/aws/ecr) · [17 — Auto Scaling](/learn/aws/auto-scaling) | the registry, and what scales |
...
> Ansible's remaining job is the build host. Chapter 20 still covers `kubeadm`,
> because knowing how a cluster is actually born is what makes the managed one
> comprehensible rather than magic.

| Read first |
|------------|
| [14 — Ansible](/learn/ansible/ansible) — roles, idempotency, dynamic inventory |
| [20 — Kubeadm](/learn/kubernetes/kubeadm) — what EKS is doing for you |
| [23 — Jenkins](/learn/jenkins/jenkins) — what you are installing, and why |
