...
capstonePurpose: "contrasts GitHub-native CI with the Jenkins pipeline the capstone uses"
capstoneWhy: "The capstone's pipeline is Jenkins. This is the same delivery expressed on hosted runners with OIDC, and worth knowing; you do not need to build both."
level: intermediate
type: concept
phase: cicd
order: 35
...
In [Continuous Integration](/learn/jenkins/jenkins/), we learned about Jenkins. Jenkins is incredibly powerful, but it requires you to maintain a server. If the Jenkins Master crashes, you have to wake up at 2 AM to fix it.
...
> **Practise:** [GitHub Actions: Build, Scan and Deploy to EKS](/labs/lab-github-actions-ecr-eks)
> builds the same pipeline here, with OIDC instead of stored keys.
...
[Contents](/learn) | [Container Registry (AWS ECR)](/learn/aws/ecr) |
