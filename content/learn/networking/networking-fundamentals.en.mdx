...
> **Practise:** [Production DNS & TLS with Route 53 and ACM](/labs/lab-aws-route53-acm-dns)
> puts a real name and a real certificate in front of a service.
...
> runs these commands against a host that is genuinely misconfigured.

> **Practise:** [HTTP & TLS Troubleshooting](/labs/lab-http-tls-troubleshooting)
> is where a certificate, a name and a port disagree.

> **Practise:** [Reverse Proxy & Load Balancing with Nginx](/labs/lab-reverse-proxy-load-balancing)
> puts one address in front of several backends.
