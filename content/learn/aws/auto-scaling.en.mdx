...
> **Practise:** [Kubernetes Security Hardening & HPA](/labs/lab-13-kubernetes-security-hardening-networkpolicies-hpa)
> runs the same elasticity idea one layer up, where the capstone actually
> scales.
