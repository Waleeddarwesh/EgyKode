...
There is no lab dedicated to Maven and Gradle themselves — the build is exercised
where it matters, inside a pipeline:

- [Enterprise Multibranch CI/CD with SonarQube & Trivy](/labs/lab-16-enterprise-multibranch-ci-cd-pipeline-with-sonarqube-trivy)
  — the same build, run by CI, with its output becoming an image
- [Production-Grade Multi-Stage Dockerfile](/labs/lab-09-production-grade-multi-stage-dockerfile-for-django-gunicorn) — what
  happens to the artifact this chapter produced
