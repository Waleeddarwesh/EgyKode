...
<LabStep n={2} title="Data worth losing" proves="You can put data in that you are willing to lose, so the recovery is a real one">
...
<LabStep n={4} title="The incident" proves="You can start the clock at the moment of the decision, which is where RTO is actually measured">
