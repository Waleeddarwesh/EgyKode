...
<LabStep n={1} title="reset --hard, undone" proves="You can recover commits the reflog still knows about after a hard reset">
...
<LabStep n={2} title="A deleted branch" proves="You can restore a branch you deleted, from the hash the reflog kept">
