...
<LabStep n={1} title="The VPC and two subnets" proves="You can build a VPC with a public and a private subnet by hand, so you know what the module was doing" criterion={1}>
...
<LabStep n={2} title="The one route that changes everything" proves="You can point at the single route that makes a subnet public" criterion={3}>
...
<LabStep n={3} title="Security groups, and what stateful means" proves="You can explain why a security group needs no return rule">
...
<LabStep n={4} title="Public and private instances" proves="You can show one instance reachable over SSH and the other not" criterion={2}>
...
<LabStep n={5} title="Reaching the private instance without a NAT Gateway" proves="You can reach a private instance without giving it a public IP or paying for a NAT Gateway" criterion={4}>
