...
<LabStep n={1} title="A registry that scans and prunes" proves="You can create a registry that scans what you push and expires what you stop tagging" criterion={[1, 2]}>
...
<LabStep n={3} title="Push an image" proves="You can push an image and read the scan findings it produced">
