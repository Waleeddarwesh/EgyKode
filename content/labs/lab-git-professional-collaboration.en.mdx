...
<LabStep n={1} title="A check for the branch to depend on" proves="You can create a check that has run at least once, which is what branch protection can then require">
...
<LabStep n={5} title="The pull request" proves="You can open a pull request that says what a reader can now do, not merely what changed">
