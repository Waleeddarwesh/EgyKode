...
handsOn:
  online:
    platform: killercoda
    enabled: true
    url: "https://killercoda.com/waleeddarwesh/scenario/aws-vpc-networking"
  cloud:
    enabled: true
    platform: aws
...
<LabStep n={1} title="The network" proves="You can lay out a VPC across two availability zones with a public and a private subnet in each" criterion={1}>
...
<LabStep n={2} title="The NAT Gateway, and what it costs" proves="You can give private subnets outbound internet access that cannot be reached inbound, and say what it costs per hour" criterion={2}>
...
<LabStep n={3} title="Route tables — where public and private are actually decided" proves="You can point at the route table entry that makes a subnet public, rather than at its name" criterion={3}>
...
<LabStep n={4} title="Apply" proves="You can apply until a second plan reports no changes" criterion={4}>
