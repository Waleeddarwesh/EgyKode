...
<LabStep n={1} title="A hosted zone" proves="You can create a hosted zone and confirm delegation actually reached it">
...
<LabStep n={2} title="A certificate, validated by DNS" proves="You can validate a certificate by DNS, and explain why the validation record must stay" criterion={3}>
...
<LabStep n={3} title="The records" proves="You can say why the apex uses an ALIAS rather than a CNAME" criterion={2}>
...
<LabStep n={4} title="Verify all four layers" proves="You can confirm the site answers on your domain with a valid certificate, checked at each layer" criterion={1}>
...
<LabStep n={5} title="TTL, and cutovers" proves="You can read the remaining TTL and say what it means for a cutover" criterion={4}>
