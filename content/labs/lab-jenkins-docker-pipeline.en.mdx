...
handsOn:
  online:
    platform: killercoda
    enabled: true
    url: "https://killercoda.com/waleeddarwesh/scenario/jenkins-docker-pipeline"
  local:
    enabled: true
    environment: cicd
    tools:
...
Use a **frozen point release of a supported distribution**, not an end-of-life
one:
...
Measured today: `debian:12.5-slim` reports **15** distinct HIGH or CRITICAL
