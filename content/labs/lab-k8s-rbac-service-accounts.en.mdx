...
<LabStep n={2} title="A Role, which names nobody" proves="You can write a Role that grants verbs on resources without naming any subject">
...
<LabStep n={3} title="A RoleBinding, which names the subject" proves="You can bind a Role to a subject, and see the binding as the thing that grants access">
