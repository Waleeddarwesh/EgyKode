...
<LabStep n={1} title="The local checks" proves="You can run the checks locally that CI will run, before pushing">
...
<LabStep n={2} title="Lint what validate cannot see" proves="You can catch the mistakes validate cannot see">
...
<LabStep n={3} title="Scan for insecure defaults" proves="You can scan configuration for insecure defaults rather than reviewing for them by eye">
