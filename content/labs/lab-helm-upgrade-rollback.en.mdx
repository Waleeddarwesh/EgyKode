...
handsOn:
  online:
    platform: killercoda
    enabled: true
    url: "https://killercoda.com/waleeddarwesh/scenario/helm-upgrade-rollback"
  local:
    enabled: true
    environment: k8s
    tools:
...
<LabStep n={1} title="A release to operate" proves="You can install a release you can then operate on" criterion={1}>
