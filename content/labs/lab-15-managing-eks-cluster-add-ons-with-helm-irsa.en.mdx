...
<LabStep n={1} title="The role, trusted by one ServiceAccount" proves="You can scope an IAM role to a single ServiceAccount rather than to the whole node" criterion={1}>
...
<LabStep n={2} title="The ServiceAccount carries the ARN" proves="You can prove a Pod assumes its own role, and that one without the annotation is refused" criterion={[2, 3]}>
...
<LabStep n={3} title="Install the add-ons" proves="You can install the add-ons that give kubectl top and an HPA a metric to read" criterion={4}>
