...
<LabStep n={1} title="The anatomy of a policy" proves="You can explain why ListBucket and GetObject need different resource ARNs" criterion={2}>
...
<LabStep n={2} title="Create and attach" proves="You can attach a policy to a principal and know which of the two you are changing">
...
<LabStep n={3} title="Prove what it allows *and* what it blocks" proves="You can prove what a policy allows and what it refuses, without waiting to be surprised" criterion={1}>
...
<LabStep n={4} title="Roles instead of keys" proves="You can assume a role and receive credentials that expire, instead of carrying a key" criterion={3}>
...
<LabStep n={5} title="Deny always wins" proves="You can say what an explicit Deny does to an Allow, from any policy" criterion={4}>
...
<LabStep n={6} title="When permissions behave strangely" proves="You can check which principal you actually are before blaming the policy">
