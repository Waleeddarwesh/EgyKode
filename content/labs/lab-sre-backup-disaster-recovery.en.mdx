...
<LabStep n={2} title="A backup that verifies itself" proves="You can write a backup that checks itself rather than one that only appears to have run">
...
<LabStep n={3} title="The disaster" proves="You can destroy the data deliberately and start the clock at the decision">
