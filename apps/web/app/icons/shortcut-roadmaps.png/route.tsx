...
import { GLYPH_ROADMAPS, ShortcutIcon } from "../shared";

/**
 * 96x96 jump-list icon for the "roadmaps" shortcut.
 *
...
export function GET() {
  return new ImageResponse(<ShortcutIcon size={96}>{GLYPH_ROADMAPS}</ShortcutIcon>, {
    width: 96,
    height: 96,
  });
}
